...
{
    public class MyDBContext<TKey> : BlazorAccessControl.EFCore.DBContext<TKey> where TKey:System.IEquatable<TKey>
    {
        ...
        public MyDBContext(DbContextOptions<MyDBContext<TKey>> options, IConfiguration config)
        {
            this.config = config;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    v => v.ToString());      // Guid -> string (from database)

            //modelBuilder.Entity<ApplicationUser<string>>().Property(i=>i.Id)
            //                                      .HasConversion(stringToGuidConverter)
            //                                      .HasColumnType("uniqueidentifier");
            //modelBuilder.Entity<ApplicationRole<string>>().Property(i=>i.Id)
            //                                      .HasConversion(stringToGuidConverter)
            //                                      .HasColumnType("uniqueidentifier");
            //modelBuilder.Entity<ApplicationUserClaim<string>>().Property(i=>i.Id)
            //                                      .HasConversion(stringToGuidConverter)
            //                                      .HasColumnType("uniqueidentifier");
            //modelBuilder.Entity<ApplicationRoleClaim<string>>().Property(i=>i.Id)
            //                                      .HasConversion(stringToGuidConverter)
            //                                      .HasColumnType("uniqueidentifier");
